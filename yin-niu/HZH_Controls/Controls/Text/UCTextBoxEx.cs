...
namespace HZH_Controls.Controls
{
    ...
    public partial class UCTextBoxEx : UCControlBase
    {
        ...
        bool isFouceShowKey = false;

        [Description("获取焦点时是否显示键盘"), Category("自定义")]
        public bool IsFouceShowKey
        {
            get { return isFouceShowKey; }
            set
            {
                isFouceShowKey = value;
            }
        }
        ...
        public UCTextBoxEx()
        {
            ...
            txtInput.GotFocus += (a, b) =>
            {
                ...
                if (isFouceShowKey)
                {
                    btnKeybord_MouseDown(null, null);
                }
            };
