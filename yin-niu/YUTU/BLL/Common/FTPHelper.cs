...
namespace YUTU.BLL.Common
{
    public class FTPHelper
    {
        ...
        {
            //FtpServerIP = "ftp://192.168.200.226/2016/WEIGHT/01001/";
            //FtpUserID = "administrator";
            //FtpPassword = "Dean0624";
        ...
        public void Download(string filePath, string fileName)
        {
            try
            {
                ...
                FtpWebRequest reqFTP;
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(ftpURI + fileInf.Name));
                //ftp://10.45.13.32:21/quarry//
                //reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri("ftp://10.45.13.32:21//quarry//" + fileInf.Name));
                reqFTP.Credentials = new NetworkCredential(ftpUserID, ftpPassword);
