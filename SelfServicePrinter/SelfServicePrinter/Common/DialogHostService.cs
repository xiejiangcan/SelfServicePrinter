...
namespace SelfServicePrinter.Common
{
    public class DialogHostService : DialogService, IDialogHostService
    {
        ...
        public async Task<IDialogResult> Question(string title, string content, string dialogHostName = "Root")
        {
            DialogParameters param = new DialogParameters();
            param.Add("Title", title);
            param.Add("Content", content);
            param.Add("dialogHostName", dialogHostName);
            var dialogResult = await this.ShowDialog("MsgView", param, dialogHostName);
            return dialogResult;
        }
